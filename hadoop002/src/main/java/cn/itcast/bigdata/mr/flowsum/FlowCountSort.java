...
/**
 * @Author  SteveTao
 * @Description 统计好的日志流量数据，按照从大到小排序
 * 输入数据格式：  13502468823	7335	110349	117684
 * @Date 2020/2/20 11:15
 **/
public class FlowCountSort {
	...
	public static void main(String[] args) throws Exception {
		...
		//指定job的输入原始文件所在目录
		FileInputFormat.setInputPaths(job, new Path("E:\\bigdataWork\\hadoop\\flowonput"));
		//指定job的输出结果所在目录
		
		Path outPath = new Path("E:\\bigdataWork\\hadoop\\flowSortonput");
